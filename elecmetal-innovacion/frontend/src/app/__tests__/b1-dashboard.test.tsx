/**
 * B1 tests - Dashboard + sidebar sesiones.
 */
...
/** URL map mock: all patterns registered at once for parallel queries */
...
describe("B1 | Dashboard page", () => {
  ...
  it("muestra estado vacio sin iniciativas", async () => {
    ...
    await waitFor(() => { expect(screen.getByText(/No tienes iniciativas/)).toBeInTheDocument(); });
  });
